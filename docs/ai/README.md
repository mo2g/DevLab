...
| --- | --- | --- |
| [one-api](https://github.com/mo2g/one-api) | Fork / maintenance-oriented work | Relevant to LLM gateway, key distribution, and multi-provider API operations |
| [MetaGPT](https://github.com/mo2g/MetaGPT) | Fork / participation-oriented work | Relevant to multi-agent software workflow exploration |
